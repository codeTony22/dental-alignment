...
describe("the parity chrome (ledger row 9): HUDs on the glass, the demo's clothes", () => {
  const layers = {
    ...
    // Retargeted 2026-08-10 (§10-AS.5, client over a Delivery screenshot: "this
    // should be the color of the scan panels in the middle"): the cap-crop layers
    // wear the scan's own tan (paletteHex("arch"), #f2e3a6) again, superseding
    // §10-AO's bone-white — see SitePanes.test.tsx for the real hook's pin.
    scan: [
